...
class ClientSerializer:
    ...
    def serialize_60113(netid, p: common.PacketReader):
        ...
        n = p.read_u16()
        print('    field5_count=%d' % n)
        for _ in range(n):
            print('        %d' % p.read_u8())
        n = p.read_u16()
        print('    field6_count=%d' % n)
        for _ in range(n):
            print('        %d' % p.read_u8())
        print('}')
    ...
    def serialize_60195(netid, p: common.PacketReader):
        ...
        for _ in range(n):
            print('        %d' % p.read_u32())
        print('    field5=%d' % p.read_u16())
        print('    field6=%d' % p.read_u16())
        print('    field7=%d' % p.read_u16())
        print('    field8=%d' % p.read_u16())
        print('    field9=%d' % p.read_u16())
        print('    field10=%d' % p.read_u16())
        print('    field11=%d' % p.read_u16())
        print('    field12=%d' % p.read_u16())
        print('    field13=%d' % p.read_u16())
        print('    field14=<unknown>')
        print('    field15=%d' % p.read_u16())
        print('    field16=%d' % p.read_u32())
        print('    field17=%d' % p.read_u32())
        print('    field18=%d' % p.read_u16())
        print('    field19=%d' % p.read_u16())
        print('    field20=%d' % p.read_u16())
        print('    field21=%d' % p.read_u8())
        print('    field22=%d' % p.read_u8())
        print('    field23=%d' % p.read_u16())
        print('    field24=%d' % p.read_u8())
        print('    field25=%d' % p.read_u32())
        print('    field26=%d' % p.read_u32())
        print('    field27=%d' % p.read_u32())
        print('    field28=%d' % p.read_u32())
        print('    field29=%d' % p.read_u32())
        print('    field30=%d' % p.read_u8())
        print('    field31=%d' % p.read_u8())
        print('}')
    def serialize_60196(netid, p: common.PacketReader):
        ...
        print('    field16=%d' % p.read_u32())
        print('    field17=%d' % p.read_u32())
        print('    field18=%d' % p.read_u32())
        print('    field19=%d' % p.read_u32())
        print('    field20=%d' % p.read_u32())
        print('    field21=%d' % p.read_u32())
        print('    field22=%d' % p.read_u32())
        print('    field23=%d' % p.read_u32())
        print('    field24=%d' % p.read_u8())
        print('    field25=%d' % p.read_u8())
        print('}')
