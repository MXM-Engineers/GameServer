...
struct IGame
{
	...
	virtual void OnPlayerUpdatePosition(i32 clientID, ActorUID characterActorUID, const vec3& pos, const vec3& dir, const RotationHumanoid& rot, f32 speed, ActionStateID state, i32 actionID) = 0;
	virtual void OnPlayerUpdateRotation(i32 clientID, ActorUID characterActorUID, const RotationHumanoid& rot) {}
...
struct Game: IGame
{
	...
	void OnPlayerUpdatePosition(i32 clientID, ActorUID characterActorUID, const vec3& pos, const vec3& dir, const RotationHumanoid& rot, f32 speed, ActionStateID state, i32 actionID) override;
